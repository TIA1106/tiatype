...
export default function SignupPage() {
  ...
  return (
    <div className='bg-teal-100 min-h-screen pt-20'>
      <h1 className='text-center font-bold text-2xl p-3 text-teal-800'>Sign Up</h1>
      <form onSubmit={handleSignup} className='mx-auto max-w-md flex flex-col gap-4'>
        ...
        <button type="submit" className='bg-teal-700 cursor-pointer text-white font-bold rounded w-fit px-5 py-3 my-3'>
          Create Account
        </button>
      </form>
    </div>
